...
SELECT track_name, MAX(duration) maxi FROM tracks
GROUP BY track_name
ORDER BY maxi DESC
LIMIT 1;

-- Название треков, продолжительность которых не менее 2.6 минут.
...
SELECT collection_name, COUNT(*) FROM collection_of_songs cs
